...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn(cs, className)}>
      <div className="flex flex-col text-[1.25rem] font-bold pt-[2.4375rem] pl-[2.3rem] 2xl:pl-[2.9375rem]">
        <div
        ...
        >
          ...
          />
          <div className="pl-[0.8rem] 2xl:pl-[1.125rem]">Trending</div>
        </div>
        <div
        ...
        >
          <img
            ...
            className="w-[1.1912rem] h-[1.5883rem]"
          />
          <div className="pl-[0.8rem] 2xl:pl-[1.125rem]">Mill</div>
        </div>
        <div
          className="flex pt-[2.625rem] cursor-pointer"
          onClick={() => {
        ...
        >
          <img
            ...
            className="w-[1.1912rem] h-[1.5883rem]"
          />
          <div className="pl-[0.8rem] 2xl:pl-[1.125rem]">Wallet</div>
        </div>
      </div>
      <div
        className="flex py-[.5rem] px-[1.375rem] mt-[2.25rem]  w-[8.875rem] rounded-[2.5rem] cursor-pointer mx-auto"
        style={{
          background:
